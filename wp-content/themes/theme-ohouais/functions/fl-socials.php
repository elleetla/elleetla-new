<?php
/*
 * FLatLayers Social Profiles Widget
 */

class rosanna_Socials extends WP_Widget {
...
// register widget
function register_rosanna_socials() {
    register_widget('rosanna_Socials');
}

add_action('widgets_init', 'register_rosanna_socials');
